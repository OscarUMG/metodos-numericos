        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../regla-falsa">
                        <i class="ni ni-ruler-pencil text-success"></i> Método Regla Falsa
                        </a>
                    </li>
                </ul>
        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="table-responsive">
                    <p>
                        <h1 class="text-center">Método de Regla Falsa</h1>
                    </p>
                    ...
                    <table class="table">
                        ...
                        <?php for($i=1;$fin>0.001;$i++){?>
                            <tr>
                                ...
                                <td><?php echo $xr= round((($x1*$resultado_x2)-($x2*$resultado_x1))/($resultado_x2-$resultado_x1),4)?></td>
                                <td><?php 
                            ...
                            <?php 
                                ...
                                $fa[] = $resultado_x1;
                                $fb[] = $resultado_x2;
                                $xr2[] = round((($a[$i]*$fb[$i])-($b[$i]*$fa[$i]))/($fb[$i]-$fa[$i]),4);
                                $fxr[] = $funcion_xr;
                                $con = 1;    
                                }else{?>
                            <tr>
